...
const FoodItem: React.FC<FoodItemProps> = ({ foodItem }) => {
    ...
    return (
        <div className={'flex justify-between gap-12 p-3 my-2 border-1 border-gray-500 from-gray-900 to-cyan-950 bg-gradient-to-tl hover:from-gray-800 hover:to-cyan-850 hover:scale-102 ease-in-out transition-all cursor-pointer rounded-2xl lg:w-[900px] w-[90vw]'}>
            <div className={'w-4/6'}>
